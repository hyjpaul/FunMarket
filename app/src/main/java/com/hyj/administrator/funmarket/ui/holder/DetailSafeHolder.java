 ...
 * 首页应用详情页-安全模块
 */
public class DetailSafeHolder extends MyBaseHolder<AppInfo> {
    ...
    public View initView() {
        View view = UiUtil.inflateView(R.layout.layout_detail_safeinfo);
...
//                System.out.println("最新高度:" + height);
    ...
    protected void refreshView(AppInfo data) {
        ...
        // 获取安全描述的完整高度
        llDesRoot.measure(0, 0);//宽高测量值传0，0表示让系统自动测量
