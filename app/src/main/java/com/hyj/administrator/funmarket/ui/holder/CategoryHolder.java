 ...
 * 分类的应用holder
 */
public class CategoryHolder extends MyBaseHolder<CategoryInfo> implements View.OnClickListener {
    ...
    public View initView() {
        View view = UiUtil.inflateView(R.layout.list_item_category);
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            case R.id.ll_grid1:
                Toast.makeText(UiUtil.getContext(), info.name1, Toast.LENGTH_SHORT)
                        .show();
                break;
            case R.id.ll_grid2:
                Toast.makeText(UiUtil.getContext(), info.name2, Toast.LENGTH_SHORT)
                        .show();
                break;
            case R.id.ll_grid3:
                Toast.makeText(UiUtil.getContext(), info.name3, Toast.LENGTH_SHORT)
                        .show();
                break;
