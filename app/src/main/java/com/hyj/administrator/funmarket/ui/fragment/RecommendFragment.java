...
import com.hyj.administrator.funmarket.http.protocol.RecommendProtocol;
import com.hyj.administrator.funmarket.ui.view.LoadPage;
import com.hyj.administrator.funmarket.ui.view.fly.ShakeListener;
import com.hyj.administrator.funmarket.ui.view.fly.StellarMap;
...
public class RecommendFragment extends BaseFragment {
    ...
    public View onCreateSuccessView() {
        ...
        stellar.setAdapter(new MyAdapter());

        // 随机方式, 将控件划分为9行6列的的格子, 然后在格子中随机展示
        stellar.setRegularity(9, 6);
        ...
        ShakeListener shake = new ShakeListener(UiUtil.getContext());
    ...
    private class MyAdapter implements StellarMap.Adapter {
        ...
        // 返回某组的item个数
        @Override
        public int getCount(int group) {//group是第几组
        ...
        public View getView(int group, int position, View convertView) {
            ...
            view.setTextSize(TypedValue.COMPLEX_UNIT_SP, size);//设置字体大小
...
//            System.out.println("isZoomIn:" + isZoomIn);往下滑加载上一页为true
            if (isZoomIn) {
                // 往下滑加载上一页
                if (group > 0) {
                    group--;
